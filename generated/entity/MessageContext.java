...
public class MessageContext extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  ...
  public entity.Message createMessage(entity.Message msg) {
    return ((com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods")).createMessage(msg);
  }
  
  public entity.Message createMessage(java.lang.String payLoad) {
    return ((com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.ab.domain.messaging.impl.MessageContextCoreExtMethods")).createMessage(payLoad);
  }
